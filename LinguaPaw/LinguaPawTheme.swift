...
/// Фирменные цвета LinguaPaw. Тот же фиолетовый, что используется в онбординге —
...
struct BrandGradientButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            ...
            .padding(.vertical, 16)
            .background(isDisabled ? AnyShapeStyle(Color.secondary.opacity(0.4)) : AnyShapeStyle(LinguaPawTheme.brandGradient))
